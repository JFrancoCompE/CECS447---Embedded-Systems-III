...
// September 15, 2013
// Port B bits 5-0 have the 3-bit DAC
...
const unsigned char SineWave[64] = {32, 35, 38, 41, 44, 47, 49, 52, 54, 56,
																		58, 59, 61, 62, 62, 63, 63, 63, 62, 62,
																		61, 59, 58, 56, 54, 52, 49, 47, 44, 41,
																		38, 35, 32, 29, 26, 23, 20, 17, 15, 12,
																		10,  8,  6,  5,  3,  2,  2,  1,  1,  1,
																		 2,  2,  3,  5,  6,  8, 10, 12, 15, 17,
																		20, 23, 26, 29};

// **************DAC_Init*********************
// Initialize 6-bit DAC using PortB pins PB6-0 
// Input: none
// Output: none
void DAC_Init(void){unsigned long volatile delay;
  ...
  GPIO_PORTB_DIR_R |= 0x3F;      		// make PB6-0 out
  GPIO_PORTB_AFSEL_R &= ~0x3F;   		// disable alt funct on PB6-0
  GPIO_PORTB_DEN_R |= 0x3F;      		// enable digital I/O on PB6-0
  GPIO_PORTB_DR8R_R |= 0x3F;     		// enable 8 mA drive on PB6-0
}

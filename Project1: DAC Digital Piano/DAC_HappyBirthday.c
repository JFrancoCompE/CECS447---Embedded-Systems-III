...
// C, D, E, F, G, A, B
// 1, 2, 3, 4, 5, 6, 7
{76445,68104,60675,57269,51021,45455,40495, // C5 Major
 38223,34052,30337,28635,25510,22727,20248, // C6 Major
 19111,17026,15169,14317,12755,11364,10124};// C7 Major
